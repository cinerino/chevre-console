...
const paymentCardRouter = express_1.Router();
paymentCardRouter.all('/new', ...validate(), (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let message = '';
    let errors = {};
...
(req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const searchConditions = {
            ...
            page: page,
            project: { id: { $eq: req.project.id } },
            typeOf: { $eq: productType_1.ProductType.PaymentCard }
        };
...
paymentCardRouter.all('/:id', ...validate(), 
// tslint:disable-next-line:cyclomatic-complexity max-func-body-length
...
paymentCardRouter.get('', (__, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.default = paymentCardRouter;
