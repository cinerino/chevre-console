$(function () {
    ...
    var inCodeSetInCodeSetSelection = $('#inCodeSet\\[inCodeSet\\]\\[codeValue\\]');
    inCodeSetInCodeSetSelection.select2({
    ...
    function showAdditionalProperty(codeValue) {
        ...
        if (Array.isArray(accountTitle.additionalProperty)) {
            ...
            tbody.append(accountTitle.additionalProperty.map(function (property) {
                return $('<tr>').append([
