...
const sets: ICategoryCodeSet[] = [
    ...
    { identifier: chevre.factory.categoryCode.CategorySetIdentifier.CurrencyType, name: '通貨区分' },
    { identifier: chevre.factory.categoryCode.CategorySetIdentifier.AccountType, name: '旧通貨区分(非推奨)' }
];
